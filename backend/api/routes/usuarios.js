...
router.route( '/' )
    .get(
        ...
        body( 'usuario' , 'Campo obligatorio (entre 3 y 15 caracteres)' ).optional().isString().isLength( { min: 3 , max: 15 } ),
        body( 'nombre' , 'Campo obligatorio (entre 3 y 40 caracteres)' ).optional().isString().isLength( { min: 3 , max: 40 } ),
        body( 'sexo' , 'Campo obligatorio (entero: 0, 1, 2 o 9)' ).optional().isInt().custom( ( sexValue , { req } ) => {
            if( ( sexValue !== 0 ) &&
                ( sexValue !== 1 ) &&
                ( sexValue !== 2 ) &&
                ( sexValue !== 9 ) ){
