...
router.route( '/' )
    .get(
        validateJWT,
        query( 'usuario' , 'Entre 1 y 25 caracteres' ).optional().isString().isLength( { min: 1 , max: 25 } ),
    ...
    .post(
        ...
        body( 'usuario' , 'Entre 3 y 25 caracteres' ).optional().isString().isLength( { min: 3 , max: 25 } ),
